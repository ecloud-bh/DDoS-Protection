...
<link rel="shortcut icon" type="image/png" href="http://www.e-cloud.web.tr/images/favicon.png"/>
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.5.0/jquery.min.js"></script>
<title>TEST SAYFASI 2</title>
</head>
<body>
    <div class="wrap">
		<br>
		...
		<br>
		<br>
        <div class="firewall animated flash infinite" id="flash"><img src="http://www.e-cloud.web.tr/images/ecloud.png" /></div>
        <br>
        <br>
        <br>
        <br>
        <br>
        <div class="title animated zoomIn">BARSEC KONTROL</div>
        <br>
        <div class="title-sub animated zoomIn">BU SAYFA TEST AMAÇLI OLUŞTURULMUŞTUR</div>
        <br>
...
<br>
<div class="shine"><b>Copyright 2016 &copy; SECTURES</b></div>
...
SEED="QugZ0Zih1l3CnAW28tFkV8SwRRS14Tnq";
TARGET="0beef";
...
$(function() {
    window.setTimeout(function() {
        ...
        $.ajax({type: "GET", url: "/___", da-ta: resp}).done(function(data) {
            window.location.replace(data || window.location.href);
        })
        .fail(function() {
            die_now("Koruma Aktif.");
        });
    }, 5000);
